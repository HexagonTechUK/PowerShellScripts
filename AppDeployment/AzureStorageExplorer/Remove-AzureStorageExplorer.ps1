...
.OUTPUTS
    Log file saved to: C:\ProgramData\_MEM\Remove-AzureStorageExplorer.log

.NOTES
    File Name : Remove-AzureStorageExplorer.ps1  
...
.EXAMPLE
    Unnstalls AzureStorageExplorer:
    winget uninstall --id Microsoft.Azure.StorageExplorer -e --silent
#>
