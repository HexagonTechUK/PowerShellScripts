...
.OUTPUTS
    Console output: "Found $programName" if installed, error if WinGet is missing.

.NOTES
    File Name : Get-AzureStorageExplorerVersion.ps1  
    Author    : Paul Gosling, Hexagon Technology Consulting  
    Created   : 2025-05-12  
    Requires  : WinGet, Windows 10/11
#>

$productName = "AzureStorageExplorer"   #--------------------------------------# Application name or function for logfile  
$programName = "Microsoft.Azure.StorageExplorer"   #---------------------------# WinGet application ID 
