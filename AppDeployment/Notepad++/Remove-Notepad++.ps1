...
.OUTPUTS
    Log file saved to: C:\ProgramData\_MEM\Remove-Notepad++.log

.NOTES
    File Name : Remove-Notepad++.ps1  
...
.EXAMPLE
    Unnstalls Notepad++:
    winget uninstall --id Notepad++.Notepad++ -e --silent
#>

# Variables (complete these):
$deployType  = "Remove"   #--------------------------------------------------------# Deployment type: Install, Upgrade, Removal
$productName = "Notepad++"   #-----------------------------------------------------# Application name for logfile
$programName = "Notepad++.Notepad++"   #-------------------------------------------# Deployment type: Install, Upgrade, Removal
