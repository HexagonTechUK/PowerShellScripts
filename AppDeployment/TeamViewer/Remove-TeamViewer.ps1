...
.OUTPUTS
    Log file saved to: C:\ProgramData\_MEM\Remove-TeamViewer.log

.NOTES
    File Name : Remove-TeamViewer.ps1  
...
.EXAMPLE
    Unnstalls TeamViewer:
    winget uninstall --id TeamViewer.TeamViewer -e --silent
#>
...
$programName = "TeamViewer.TeamViewer"   #-----------------------------------------# Deployment type: Install, Upgrade, Removal
