...
.OUTPUTS
    Log file saved to: C:\ProgramData\_MEM\Remove-OracleVirtualBox.log

.NOTES
    File Name : Remove-OracleVirtualBox.ps1  
...
.EXAMPLE
    Unnstalls OracleVirtualBox:
    winget uninstall --id Oracle.VirtualBox -e --silent
#>
...
& $winget_exe uninstall --exact --id $programName --all-versions --silent --accept-source-agreements --scope=machine $param
