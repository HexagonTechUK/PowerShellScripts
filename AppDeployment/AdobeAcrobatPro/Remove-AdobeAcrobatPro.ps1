...
.OUTPUTS
    Log file saved to: C:\ProgramData\_MEM\Remove-AdobeAcrobatPro.log

.NOTES
    File Name : Remove-AdobeAcrobatPro.ps1  
...
.EXAMPLE
    Unnstalls AdobeAcrobatPro:
    winget uninstall --id Adobe.Acrobat.Pro -e --silent
#>
