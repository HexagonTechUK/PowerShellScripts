...
.NOTES
    File Name : Get-AdobeAcrobatProVersion.ps1  
    Author    : Paul Gosling, Hexagon Technology Services  
    Created   : 2025-05-14  
    Requires  : WinGet, Windows 10/11
#>

$productName = "AdobeAcrobatPro"   #-------------------------------------------# Application name or function for logfile  
$programName = "Adobe.Acrobat.Pro"   #-----------------------------------------# WinGet application ID 
