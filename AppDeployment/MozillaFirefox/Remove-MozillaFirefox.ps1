...
.OUTPUTS
    Log file saved to: C:\ProgramData\_MEM\Remove-MozillaFirefox.log

.NOTES
    File Name : Remove-MozillaFirefox.ps1  
...
.EXAMPLE
    Unnstalls MozillaFirefox:
    winget uninstall --id Mozilla.Firefox -e --silent
#>
