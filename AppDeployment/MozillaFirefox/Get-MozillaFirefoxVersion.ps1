...
.NOTES
    File Name : Get-MozillaFirefoxVersion.ps1  
    Author    : Paul Gosling, Hexagon Technology Consulting  
    Created   : 2025-05-14  
    Requires  : WinGet, Windows 10/11
#>

$productName = "MozillaFirefox"   #-------------------------------------------------# Application name or function for logfile  
$programName = "Mozilla.Firefox"   #---------------------------------------------------# WinGet application ID 
