...
.OUTPUTS
    Log file saved to: C:\ProgramData\_MEM\Install-AdobeCreativeCloud.log

.NOTES
    File Name : Install-AdobeCreativeCloud.ps1  
...
.EXAMPLE
    Installs AdobeCreativeCloud:
    winget install --id Adobe.CreativeCloud -e --silent
#>
