...
.NOTES
    File Name : Get-MicrosoftPowerBIVersion.ps1  
    Author    : Paul Gosling, Hexagon Technology Services  
    Created   : 2025-05-14  
    Requires  : WinGet, Windows 10/11
#>

$productName = "MicrosoftPowerBI"   #------------------------------------------# Application name or function for logfile  
$programName = "Microsoft.PowerBI"   #-----------------------------------------# WinGet application ID 
