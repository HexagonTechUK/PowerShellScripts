...
.OUTPUTS
    Log file saved to: C:\ProgramData\_MEM\Remove-GoogleChromeBeta.log

.NOTES
    File Name : Remove-GoogleChromeBeta.ps1  
...
.EXAMPLE
    Unnstalls GoogleChromeBeta:
    winget uninstall --id Google.Chrome.Beta -e --silent
#>
